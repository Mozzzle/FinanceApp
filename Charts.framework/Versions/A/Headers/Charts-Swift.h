...
@interface NSUIAccessibilityElement : NSAccessibilityElement
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
@interface NSUIView (SWIFT_EXTENSION(Charts)) <NSAccessibilityGroup>
- (NSString * _Nullable)accessibilityLabel SWIFT_WARN_UNUSED_RESULT;
- (NSArray * _Nullable)accessibilityRows SWIFT_WARN_UNUSED_RESULT;
@end
